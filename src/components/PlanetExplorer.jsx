      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center text-center space-y-10">
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-6">
          ...
          <div className="relative w-full flex items-center justify-center">
            ...
            <button
              onClick={prev}
              className="hidden sm:block z-20 absolute left-[-3rem] text-gray-400 hover:text-white transition"
            >
              <FaArrowLeft size={32} />
            </button>
            ...
            <button
              onClick={next}
              className="hidden sm:block z-20 absolute right-[-3rem] text-gray-400 hover:text-white transition"
            >
